...
describe('Enhanced Error Messages', () => {
  ...
  describe('ValidationError', () => {
    it('should provide field-specific guidance for person', () => {
      ...
      expect(message).toBe(
        "Invalid value for field 'person': Invalid type. Please refer to the prompt template resource for the correct format."
      )
    })
    ...
    it('should provide range guidance for numberOfQuotes', () => {
      ...
      expect(message).toBe(
        "Invalid value for field 'numberOfQuotes': Out of range. Please refer to the prompt template resource for the correct format."
      )
    })
    ...
    it('should explain optional topic field', () => {
      ...
      expect(message).toBe(
        "Invalid value for field 'topic': Invalid topic. Please refer to the prompt template resource for the correct format."
      )
    })
  ...
  describe('NetworkError', () => {
    it('should include service in network error messages', () => {
      ...
      expect(message).toBe(
        'Network error: Unable to connect to serper. Please check your internet connection and ensure the service is accessible. If using a proxy or firewall, ensure it allows HTTPS connections to external APIs.'
      )
    })
    ...
    it('should provide general network troubleshooting', () => {
      ...
      expect(message).toBe(
        'Network error: Unable to connect. Please check your internet connection and ensure the service is accessible. If using a proxy or firewall, ensure it allows HTTPS connections to external APIs.'
      )
    })
  })
  ...
  describe('User Message Formatting', () => {
    it('should format errors for user display', () => {
      ...
      expect(formatted).toBe(
        "Invalid value for field 'person': Invalid input. Please refer to the prompt template resource for the correct format."
      )
    })
