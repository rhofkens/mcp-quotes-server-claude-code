...
describe('Validation Utilities', () => {
  describe('CommonSchemas', () => {
    ...
    it('should validate UUIDs', () => {
      ...
      expect(validate(CommonSchemas.uuid, '123e4567-e89b-12d3-a456-426614174000')).toBe(
    ...
    it('should validate ISO dates', () => {
      ...
      expect(validate(CommonSchemas.isoDate, '2023-01-01T00:00:00Z')).toBe('2023-01-01T00:00:00Z')
    })
  })
  ...
  describe('MCPSchemas', () => {
    it('should validate base MCP request', () => {
      ...
      expect(() =>
        validate(MCPSchemas.baseRequest, {
          jsonrpc: '1.0',
          method: 'test',
          id: 1,
        })
    ...
    it('should validate tool call request', () => {
      ...
      expect(() =>
        validate(MCPSchemas.toolCallRequest, {
          jsonrpc: '2.0',
          method: 'wrong-method',
          id: 1,
          params: { name: 'test' },
  ...
  describe('QuoteSchemas', () => {
    it('should validate getQuotes parameters', () => {
      ...
      expect(() =>
        validate(QuoteSchemas.getQuotesParams, {
          person: '',
          numberOfQuotes: 5,
        })
      ).toThrow(ValidationError)
